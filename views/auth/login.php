<?php /** @var bool $googleEnabled */ $authTitle = 'Sign in'; $authVariant = 'login'; require BASE_PATH . '/views/auth/_head.php'; ?>
<h1>Welcome back</h1>
...
<form method="post" action="<?= url('login') ?>">
  ...
  <div class="mb-3">
    ...
    <input type="email" name="email" class="form-control form-control-lg" required <?= $googleEnabled ? '' : 'autofocus' ?> placeholder="you@company.com">
  </div>
  <div class="mb-2">
